// ============================================
// FILE: routes/admin.add.tsx - SUPPORT FF + MLBB
// ============================================
...
// ================= INI YANG PALING PENTING - EXPORT ROUTE =================
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Add a new account to your store</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid xl:grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-2xl p-6 border border-border shadow-soft">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <label className="block text-xs font-medium text-muted-foreground mb-1.5">Game Type *</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-muted-foreground mb-1.5">Account Code *</label>
                  <input
                    className="w-full rounded-xl border border-border bg-background/50 px-4 py-3 text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 transition"
                ...
                <div>
                  <label className="block text-xs font-medium text-muted-foreground mb-1.5">Price (IDR) *</label>
                  <input
                    type="number"
                    className="w-full rounded-xl border border-border bg-background/50 px-4 py-3 text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/30 transition"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl p-6 border border-border shadow-soft">
              <h3 className="gradient-text font-bold mb-4 pb-4 border-b border-border">QUICK PREVIEW</h3>
        ...
        <div className="flex justify-between border-t border-border mt-8 pt-6">
          <button type="button" onClick={() => navigate({ to: "/admin/stock" })} className="px-8 py-3 rounded-xl border border-border bg-card hover:bg-accent/10 transition">
            Cancel
          </button>
          <button disabled={loading} className="px-10 py-3 rounded-xl gradient-bg flex gap-2 items-center font-bold text-white shadow-neon hover:opacity-90 transition disabled:opacity-50">
            <Save size={18} />
